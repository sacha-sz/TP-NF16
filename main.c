...
//                    scanf("%d", &vote_entrer);
//
//                    ajoutelecteur(liste, nom_entrer, cin_entrer, vote_entrer);
//                    break;
                ...
                case 2:
                 ...
                 case 3 :
                    ...
                    long cin_electeur_supprimercsupprimer_electeur_cin();
                 ...
                 case 9 :
                    ...
                    break;
                default:
                    printf("Vous avez fait une erreur dans votre choix.\n");
                    break;
            }
        }
    }
